...
BINUTILS_VERSION_DEFAULT=2.26
GCC_VERSION_DEFAULT=6.1.0
NEWLIB_VERSION_DEFAULT=2.4.0
GDB_VERSION_DEFAULT=7.11

DEST_PATH_DEFAULT="/usr/local/gcc/csibe"
DEST_PATH_SUFFIX_DEFAULT="-csibe"

HARDFLOAT_DEFAULT="N"
BUILD_GDB_DEFAULT="N"
APPLY_PATCH_DEFAULT="N"
...
if [[ $TARGET == *"arm"* ]]
then
  TARGET_OPTS="--with-endian=little --with-abi=aapcs --disable-interwork --with-mode=thumb --with-cpu=cortex-m3"
